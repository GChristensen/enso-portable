...
/* HUMANIZED EDIT: Commenting out this ifdef, which was set here
 * erroneously.  This reflects changes made to the CVS version of
 * FreeType2 in revision 1.99 of this file (sfobjs.c); the latest
 * release version that is represented by this file, unfortunately,
 * didn't include this fix. -Atul */
