...
scaled_font_new (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    /* HUMANIZED EDIT: Moved declaration of 'o' here to be ANSI C
     * compliant, as variables in ANSI C can only be defined at the
    ...
    /* HUMANIZED EDIT: The following commented-out line of code is bad
     * ANSI C--variables can only be defined at the beginning of a
     * block! */
    /* PyObject *o = type->tp_alloc(type, 0); */
    if (o) {
